...
| C2 — policy comparison | Benchmark Jev on one legal-choice decision against scripted and generative baselines. Include a slow strategic plan plus faster local choice as a measured variant; report call scaling, stale plans and outage fallback before adopting any role. | [Roadmap #15](https://github.com/School-of-the-Ancients/school-of-the-ancients-roadmap/issues/15) evaluates; Matrix #29 owns any integration. |
